...
function load_options() {
	...
	function load_default_images() {
		$this->images = array(
			array(
				'image'		=>  plugins_url( 'images/slide1.png' , __FILE__ ),
				'caption'	=> '<h3>Ontvang 5% korting op internetbestelling!</h3>
								<a class="btn" href="#">Bestel nu</a>',
				'link'		=> ''
			),
			array(
				'image'		=> plugins_url( 'images/slide2.png' , __FILE__ ), 
				'caption'	=> '<h3>Ontvang 5% korting op internetbestelling!</h3>
								<a class="btn" href="#">Bestel nu</a>',
				'link'		=> ''
			)
...
function shortcode_show_bootstrapslider()
{
	...
	foreach($this->images as $image)
	{
		...
		if(!empty($image['caption']) ) $items[$i] .= '<div class="carousel-caption"><div class="row"><div class="col-md-6 col-md-offset-1">'.stripslashes($image['caption']).'</div></div></div>';
...
?>		
	...
	<div data-ride="carousel" class="carousel slide carousel-fade" id="bootstrapslider">
